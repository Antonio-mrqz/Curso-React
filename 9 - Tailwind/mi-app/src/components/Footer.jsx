    ...
    <>
        ...
        <div className="max-w-screen-xl p-4 py-6 mx-auto lg:py-16 md:p-8 lg:p-10">
            ...
            <div className="text-center">
                <span className="block text-sm text-center text-gray-500 dark:text-gray-400">todos los derechso reservados - <a href="" className="text-purple-600 hover:underline dark:text-purple-500">Antonio.mrqz_</a>
                </span>
